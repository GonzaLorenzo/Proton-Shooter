...
public class LifeBarFA : MonoBehaviour
{
    [SerializeField]
    private Slider _lifeBar;
    [SerializeField]
    private CharacterFA _target;
    [SerializeField]
    private float _verticalOffset = 0; //500
    
    public LifeBarFA SetTarget(CharacterFA target)
    {
        _target = target;
    ...
    public LifeBarFA SetParent(Transform parent)
    {
